...
<div class="single-page clearfix">
  <div class="inner-wrap">
      ...
      <div class="row">
        <div class="large-6 columns">
          <div class="box-border">
            <h2 class="bold"> Sponser A Puppy</h2>
    ...
    <div class="add-bottom">
      <div class="row" style="border: 1px solid #eeeeee; padding: 18px;">
        <div class="large-6 columns">
          <h2 class="bold"> Tribute Cards And Memorial Gifts</h2>
            ...
            <p><span class="bold">By Phone:</span><br>
            ...
            <p><span class="bold">By Mail:</span><br>
        ...
        <div class="large-6 columns">
          <img src="https://www.placecage.com/c/500/300">
    ...
    <div class="add-bottom">
      <div class="column row">
        <h2 class="bold"> Donor Privacy Policy </h2>
